...
//			})
		...
		function loadpage(id){
			$("#content").load(id);
			//$("#judul").html('RUMAH SAKIT NADYA | Daftar "'+name+'"');
		}
		...
		function sidemenu(id){
			...
			//var anu = $('.active').html;
			$("#judul").html('RUMAH SAKIT NADYA | Daftar '+judul);
		}
		...
		function daftar() {
			var datid = $('.selected').attr('id');
			var judul = $('#toolbar').attr('class');
			$("#judul").html('RUMAH SAKIT NADYA | Tambah Pendaftaran');
			$('#content').load("view/form/tbh_pendaftaran.php?act=tambah&id="+datid);
		}

		function dash(id){
			loadpage(id);
			$("#judul").html('RUMAH SAKIT NADYA | Dashboard');
		}

		function periksa() {
			var datid = $('.selected').attr('name');
			var judul = $('#toolbar').attr('class');
			$("#judul").html('RUMAH SAKIT NADYA | Hasil Pemeriksaan');
...
<body>
	<nav>
		...
		<h3 class="float-left tittle" id="judul">RUMAH SAKIT NADYA</h3>	
		<div id="switch-color">
			<h4>Dark Theme</h4>
